...
void affect_modify(CHAR_DATA *ch, AFFECT_DATA *paf, bool fAdd) {
    ...
    case APPLY_MELPOMINEE:
        if(!IS_NPC(ch)) {
            ch->pcdata->powers_mod[DISC_MELPOMINEE] += mod;
        }
        break;
    ...
    case APPLY_THANATOSIS:
        if(!IS_NPC(ch)) {
            ch->pcdata->powers_mod[DISC_THANATOSIS] += mod;
        }
        break;
...
char *affect_loc_name(int location) {
    ...
    case APPLY_STR:
        return "Modifies strength by";
    case APPLY_DEX:
        return "Modifies dexterity by";
    case APPLY_INT:
        return "Modifies intelligence by";
    case APPLY_WIS:
        return "Modifies wisdom by";
    case APPLY_CON:
        return "Modifies constitution by";
    case APPLY_SEX:
    ...
    case APPLY_MELPOMINEE:
        return "Modifies Melpominee discipline by";
    case APPLY_NECROMANCY:
    ...
    case APPLY_THANATOSIS:
        return "Modifies Thanatosis discipline by";
    case APPLY_THAUMATURGY:
    ...
    case APPLY_SET_MELPOMINEE:
        return "Gives min Melpominee discipline of";
    case APPLY_SET_NECROMANCY:
    ...
    case APPLY_SET_THANATOSIS:
        return "Gives min Thanatosis discipline of";
    case APPLY_SET_THAUMATURGY:
