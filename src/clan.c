...
void do_tradition(CHAR_DATA *ch, char *argument) {
    ...
    do_say(ch, buf);
    if(ch->vampgen == 7) {
        sprintf(buf, "My name is %s, childe of %s, childe of %s, childe of %s, childe of %s, childe of %s, childe of %s.  Recognize my lineage.", ch->name, arg6, arg5, arg4, arg3, arg2, arg1);
    }
    if(ch->vampgen == 6) {
        sprintf(buf, "My name is %s, childe of %s, childe of %s, childe of %s, childe of %s, childe of %s.  Recognize my lineage.", ch->name, arg5, arg4, arg3, arg2, arg1);
    }
    if(ch->vampgen == 5) {
        sprintf(buf, "My name is %s, childe of %s, childe of %s, childe of %s, childe of %s.  Recognize my lineage.", ch->name, arg4, arg3, arg2, arg1);
    }
    if(ch->vampgen == 4) {
        sprintf(buf, "My name is %s, childe of %s, childe of %s, childe of %s.  Recognize my lineage.", ch->name, arg3, arg2, arg1);
    }
    if(ch->vampgen == 3) {
...
void do_mortalvamp(CHAR_DATA *ch, char *argument) {
    ...
    if(IS_VAMPIRE(ch) || IS_GHOUL(ch)) {
        ...
        if(IS_MORE(ch, MORE_PLASMA)) {
            do_plasmaform(ch, "");
        }
        if(IS_MORE(ch, MORE_ASHES)) {
            do_ashes(ch, "");
        }
        if(IS_EXTRA(ch, EXTRA_AWE)) {
            do_awe(ch, "");
...
void vamp_rage(CHAR_DATA *ch) {
    ...
    if(ch->pcdata->wolf >= (ch->beast * 0.5)) {
        return;
    }
...
void do_feed(CHAR_DATA *ch, char *argument) {
    ...
    if(IS_HERO(victim) && (victim->class == CLASS_NONE || IS_GHOUL(victim))) {
        ...
        if(!IS_NPC(victim) && victim->pcdata->dpoints < (ch->blood[2] * 1000)) {
            if(!IS_VAMPIRE(ch)) {
                victim->pcdata->dpoints += (blood * 60);
            }
...
void do_upkeep(CHAR_DATA *ch, char *argument) {
    ...
    if(IS_ANGEL(ch)) {
        ...
        default:
            break;
        case 1:
            send_to_char("You have Basic Angelic Vision.\n\r", ch);
            break;
        case 2:
            send_to_char("You have Intermediate Angelic Vision.\n\r", ch);
            break;
        case 3:
            send_to_char("You have Advanced Angelic Vision.\n\r", ch);
            break;
        case 4:
            send_to_char("You have Expert Angelic Vision.\n\r", ch);
            break;
        case 5:
            send_to_char("You have Supreme Angelic Vision.\n\r", ch);
            break;
        }
        ...
        default:
            break;
        case 1:
            send_to_char("You have Basic Obeah.\n\r", ch);
            break;
        case 2:
            send_to_char("You have Intermediate Obeah.\n\r", ch);
            break;
        case 3:
            send_to_char("You have Advanced Obeah.\n\r", ch);
            break;
        case 4:
            send_to_char("You have Expert Obeah.\n\r", ch);
            break;
        case 5:
            send_to_char("You have Supreme Obeah.\n\r", ch);
            break;
        }
        if(IS_POLYAFF(ch, POLY_ZULO)) {
        ...
        if(IS_DEMPOWER(ch, DEM_FANGS)) {
            if(IS_VAMPAFF(ch, VAM_FANGS)) {
                ...
                send_to_char("You have a pair of long pointed fangs, but they are not currently extended.\n\r", ch);
            }
        }
        if(IS_DEMPOWER(ch, DEM_CLAWS)) {
            if(IS_VAMPAFF(ch, VAM_CLAWS)) {
                ...
                send_to_char("You have a pair of razor sharp claws, but they are not currently extended.\n\r", ch);
            }
        }
        ...
        if(IS_DEMPOWER(ch, DEM_EYES)) {
            if(IS_VAMPAFF(ch, VAM_NIGHTSIGHT)) {
                send_to_char("Your eyes are glowing bright blue, allowing you to see in the dark.\n\r", ch);
            } else {
                send_to_char("You are able to see in the dark, although that power is not currently activated.\n\r", ch);
            }
        }
        if(IS_DEMPOWER(ch, DEM_WINGS)) {
            if(!IS_DEMAFF(ch, DEM_WINGS)) {
                ...
                send_to_char("You have a pair of white feathered wings unfolded behind your back.\n\r", ch);
            } else {
                send_to_char("You have a pair of white feathered wings folded behind your back.\n\r", ch);
            }
        }
        ...
        if(IS_DEMPOWER(ch, DEM_SHADOWSIGHT)) {
            if(IS_AFFECTED(ch, AFF_SHADOWSIGHT)) {
                send_to_char("You are able see things in the Umbra.\n\r", ch);
            } else {
                send_to_char("You are able to view the Umbra, although you are not currently doing so.\n\r", ch);
            }
        }
        if(IS_VAMPAFF(ch, VAM_OBFUSCATE)) {
        ...
        default:
            break;
        case 1:
            send_to_char("You have Basic Demonic Vision.\n\r", ch);
            break;
        case 2:
            send_to_char("You have Intermediate Demonic Vision.\n\r", ch);
            break;
        case 3:
            send_to_char("You have Advanced Demonic Vision.\n\r", ch);
            break;
        case 4:
            send_to_char("You have Expert Demonic Vision.\n\r", ch);
            break;
        case 5:
            send_to_char("You have Supreme Demonic Vision.\n\r", ch);
            break;
        }
        ...
        default:
            break;
        case 1:
            send_to_char("You have Basic Daimoinon.\n\r", ch);
            break;
        case 2:
            send_to_char("You have Intermediate Daimoinon.\n\r", ch);
            break;
        case 3:
            send_to_char("You have Advanced Daimoinon.\n\r", ch);
            break;
        case 4:
            send_to_char("You have Expert Daimoinon.\n\r", ch);
            break;
        case 5:
            send_to_char("You have Supreme Daimoinon.\n\r", ch);
            break;
        }
        if(IS_POLYAFF(ch, POLY_ZULO)) {
...
void do_tribe(CHAR_DATA *ch, char *argument) {
    ...
    for(gch = char_list; gch != NULL; gch = gch->next) {
        ...
        if(IS_IMMORTAL(gch) && !IS_IMMORTAL(ch) && IS_SET(gch->act, PLR_WIZINVIS)) {
            continue;
        }
...
void do_pray(CHAR_DATA *ch, char *argument) {
    ...
    for(d = descriptor_list; d != NULL; d = d->next) {
        ...
        if(IS_SET(victim->deaf, CHANNEL_PRAY)) {
            continue;
        }
        if(victim == ch) {
...
void do_powers(CHAR_DATA *ch, char *argument) {
    ...
    if(get_disc(ch, DISC_CHIMERSTRY) > 0) {
        ...
        if(get_disc(ch, DISC_CHIMERSTRY) > 1) {
            strcat(buf, " Formillusion");
        }
        if(get_disc(ch, DISC_CHIMERSTRY) > 2) {
            strcat(buf, " Clone");
        }
        if(get_disc(ch, DISC_CHIMERSTRY) > 3) {
            strcat(buf, " Falseappearance");
        }
    ...
    if(get_disc(ch, DISC_MELPOMINEE) > 0) {
        ...
        if(get_disc(ch, DISC_MELPOMINEE) > 1) {
            strcat(buf, " Reina");
        }
    ...
    if(get_disc(ch, DISC_NECROMANCY) > 0) {
        ...
        if(get_disc(ch, DISC_NECROMANCY) > 2) {
            strcat(buf, " Spiritgate");
        }
        if(get_disc(ch, DISC_NECROMANCY) > 3) {
            strcat(buf, " Spiritguardian");
        }
        if(get_disc(ch, DISC_NECROMANCY) > 4) {
            strcat(buf, " Zombie");
        }
        strcat(buf, ".\n\r");
        send_to_char(buf, ch);
    ...
    if(get_disc(ch, DISC_PRESENCE) > 0) {
        ...
        if(get_disc(ch, DISC_PRESENCE) > 1) {
            strcat(buf, " Dreadgaze");
        }
        if(get_disc(ch, DISC_PRESENCE) > 2) {
            strcat(buf, " Entrance");
        }
        if(get_disc(ch, DISC_PRESENCE) > 3) {
            strcat(buf, " Summoning");
        }
        if(get_disc(ch, DISC_PRESENCE) > 4) {
            strcat(buf, " Majesty");
        }
    ...
    if(get_disc(ch, DISC_PROTEAN) > 0) {
        ...
        if(get_disc(ch, DISC_PROTEAN) > 2) {
            strcat(buf, " Earthmeld");
        }
        if(get_disc(ch, DISC_PROTEAN) > 3) {
            strcat(buf, " Change");
        }
...
void do_beastwithin(CHAR_DATA *ch, char *argument) {
    ...
    if(IS_VAMPIRE(victim) && !IS_VAMPAFF(victim, VAM_FANGS)) {
        do_fangs(victim, "");
    }
...
void do_formillusion(CHAR_DATA *ch, char *argument) {
    ...
    if(original->class == CLASS_VAMPIRE) {
        victim->class = CLASS_VAMPIRE;
    }
    if(original->class == CLASS_GHOUL) {
        victim->class = CLASS_GHOUL;
    }
